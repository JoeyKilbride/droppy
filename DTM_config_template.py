...
# __________Defining Droplets (default - 3 droplet line) ______
...
#_________Visualisation___________________________________________
live_plot = False # off for speed, on for debugging
...
dpi=100
vid_FPS = 25 # playback rate of the exported video
export_nframes=30
